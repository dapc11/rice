...
awful.layout.layouts = {
    ...
    awful.layout.suit.tile.top, awful.layout.suit.fair, awful.layout.suit.max,
...
--  Key bindings
globalkeys = gears.table.join(awful.key({modkey}, "Tab",
...
awful.key({modkey}, "Return", function() awful.spawn(terminal) end,
    ...
    awful.spawn(
        "rofi -normal-window -show drun -display-drun '' -modi drun -theme ~/.config/rofi/config")
end, {description = "launch application", group = "launcher"}),
                              awful.key({modkey}, "BackSpace",
                                        function() awful.spawn("sysact") end, {
    description = "session management",
    group = "launcher"
}), awful.key({modkey}, "l", function() awful.spawn("sysact") end,
              {description = "session management", group = "launcher"}),
