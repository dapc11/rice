...
-- file:close()
beautiful.init("/home/dapc/.config/awesome/theme.lua")
...
-- Standard program
    ...
    awful.key({modkey}, "BackSpace", function() awful.spawn("/home/dapc/.config/awesome/sysact") end, {description = "session management", group = "launcher" }),
...
local clientkeys = gears.table.join(
    ...
    awful.key({modkey, "Control"}, "<", function (c) c:move_to_screen() end, {description = "move to screen", group = "client"}),
