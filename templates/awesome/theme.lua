...
theme.titlebar_close_button_normal = config_dir .."icons/titlebar/close_normal.png"
theme.titlebar_close_button_focus  = config_dir .."icons/titlebar/close_focus.png"
theme.titlebar_minimize_button_normal = config_dir .."icons/titlebar/minimize_normal.png"
theme.titlebar_minimize_button_focus  = config_dir .."icons/titlebar/minimize_focus.png"
theme.titlebar_minimize_button_active  = config_dir .."icons/titlebar/minimize_focus.png"
theme.titlebar_maximized_button_normal_inactive = config_dir .."icons/titlebar/maximized_normal_inactive.png"
theme.titlebar_maximized_button_focus_inactive  = config_dir .."icons/titlebar/maximized_focus_inactive.png"
theme.titlebar_maximized_button_normal_active = config_dir .."icons/titlebar/maximized_normal_active.png"
theme.titlebar_maximized_button_focus_active  = config_dir .."default/titlebar/maximized_focus_active.png"
