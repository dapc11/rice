...
if !has("gui_running")
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/dapc11.sh"
  endif
endif
...
call <sid>hi("LineNr",        s:gui03, s:gui00, s:cterm00, s:cterm03, "", "")
...
call <sid>hi("CursorLineNr",  s:gui00, s:gui03, s:cterm03, s:cterm00, "", "")
...
call <sid>hi("GitGutterAdd",     s:gui0B, s:gui03, s:cterm0B, s:cterm03, "", "")
call <sid>hi("GitGutterChange",  s:gui0D, s:gui03, s:cterm0D, s:cterm03, "", "")
call <sid>hi("GitGutterDelete",  s:gui08, s:gui01, s:cterm08, s:cterm01, "", "")
call <sid>hi("GitGutterChangeDelete",  s:gui0E, s:gui03, s:cterm0E, s:cterm03, "", "")
